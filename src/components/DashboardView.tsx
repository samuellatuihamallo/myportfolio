      ...
      <div className="lg:col-span-8 flex flex-col gap-6">
        ...
        >
          ...
          <div className="text-hud-text-dim text-sm space-y-4 leading-relaxed">
            <p>
              Born in the sprawling digital district of Neo-Veridia, <span className="text-white font-semibold">Operator_01</span> emerged as a prodigy in the art of code-weaving. While others saw binary, they saw the flow of living systems. By the age of 19, they had already breached the central mainframe of the "Obsidian Collective," not to destroy, but to optimize.
            </p>
          </div>
